...
namespace ConversaoTemperatura
{
    public class FunctionFahrenheitParaCelsius
    {
        ...
        [OpenApiParameter(name: "fahrenheit", In = ParameterLocation.Path, Required = true, Type = typeof(double), Description = "O valor em **Fahrenheit** para a conversão em Celsius")]

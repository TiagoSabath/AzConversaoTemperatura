...
namespace ConversaoTemperatura
{
    public class FunctionCelsiusParaFahrenheit
    {
        ...
        [OpenApiParameter(name: "celsius", In = ParameterLocation.Path, Required = true, Type = typeof(double), Description = "O valor em **Celsius** para a conversão em Fahrenheit")]
        [OpenApiResponseWithBody(statusCode: HttpStatusCode.OK, contentType: "text/plain", bodyType: typeof(string), Description = "O valor em Fahrenheit")]
